...
export default function ModernRoadmap() {
  ...
  return (
    <section id="roadmap" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-950 text-white">
            ...
            <div className="bg-gray-800/50 rounded-xl border border-gray-700 p-8 backdrop-blur-sm">
              ...
              <div className="mb-8">
                <h4 className="text-lg font-semibold mb-3 text-cyan-400 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 6a9 9 0 010-18m0 18a9 9 0 000-18m0 18v6m0-6v6m0-24v6m0 0h6m-6 0H3" />
                  </svg>
                  Objective
                </h4>
